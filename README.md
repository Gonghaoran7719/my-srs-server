...
![](http://ossrs.net/gif/v1/sls.gif?site=github.com&path=/tmpl/k8s/tke/Gonghaoran7719/my-srs-server)
[![](https://github.com/Gonghaoran7719/my-srs-server/actions/workflows/tencent.yml/badge.svg)](https://github.com/Gonghaoran7719/my-srs-server/actions/workflows/tencent.yml)
...
**Step 2:** Click the <kbd>Use this template</kbd> to create your repository, then set the [secrets](https://github.com/Gonghaoran7719/my-srs-server/settings/secrets/actions):
